error id: file:///D:/CODING/JAVA/consumer-service/src/main/java/com/example/consumer_service/config/KafkaConsumerService.java:_empty_/KafkaConsumerProperties#
...
public class KafkaConsumerService {
    ...
    @Autowired
    private KafkaConsumerPrope@@rties kafkaConsumerProperties;
